...
constexpr size_t   LARGE_CHUNK_SIZE    = 4 * 1024 * 1024; // 4 MB optimal streaming chunk
constexpr size_t   MAX_IN_FLIGHT_BYTES = 256 * 1024 * 1024; // 256 MB ring buffer backpressure
